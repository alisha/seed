...
@section('content')
	...
	<div class="list-group">
		...
		<a href="/hdd/data/mit1/contents/Syllabus/index.htm" target="_blank" class="list-group-item">
  		...
  		<a href="/hdd/data/mit3/contents/Syllabus/index.htm" target="_blank" class="list-group-item">
	...
	<div class="list-group">
		...
		<a href="/hdd/data/ftc/educators.pdf" target="_blank" class="list-group-item">
		    <h4 class="list-group-item-title">Educator's Guide</h4>
  		</a>
  		<a href="/hdd/data/ftc/arg/Elementary.pdf" target="_blank" class="list-group-item">
		    <h4 class="list-group-item-title">Agriculture and Food Security, Elementary Lesson Package</h4>
  		</a>
  		<a href="/hdd/data/ftc/arg/Secondary.pdf" target="_blank" class="list-group-item">
