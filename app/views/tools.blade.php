...
@section('content')
	...
	<div class="list-group">
		...
		<a href="resources/data/mit1/contents/Syllabus/index.htm" target="_blank" class="list-group-item">
		    <h4 class="list-group-item-title">Introduction to Computer Science and Programming</h4>
  		</a>
  		<a href="resources/data/mit2/contents/Syllabus/index.htm" target="_blank" class="list-group-item">
	...
	<div class="list-group">
		...
		<a href="resources/data/wikipedia/index.htm" target="_blank" class="list-group-item">
	...
	<div class="list-group">
		...
		<a href="resources/data/ftc/educators.pdf" target="_blank" class="list-group-item">
		    <h4 class="list-group-item-title">Educator's Guide</h4>
  		</a>
  		<a href="resources/data/ftc/arg/Elementary.pdf" target="_blank" class="list-group-item">
		    <h4 class="list-group-item-title">Agriculture and Food Security, Elementary Lesson Package</h4>
  		</a>
  		<a href="resources/data/ftc/arg/Secondary.pdf" target="_blank" class="list-group-item">
